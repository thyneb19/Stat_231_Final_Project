...
includedByStanford <- includedByStanford %>% mutate("IncludedStan" = "Yes")
includedByStanford

#Version 3 has better naming
joinedAllFinalInclusionTemp <- joinedAllFinalv3 %>% mutate("IncludedNo" = "No")
...
for (i in 1:879){
  if (!is.na(joinedAllFinalInclusion$IncludedStan[i])) {
    joinedAllFinalInclusionTemp$IncludedNo[i] <- "Yes"
  }
}
