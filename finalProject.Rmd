...
ggplot(shootingFreqAll,aes(week,numShootings))+geom_bar(stat="identity")
ggplot(shootingFreqStanford,aes(week,numShootings))+geom_bar(stat="identity")
```
...
gg1 + geom_point(data=joinedStanfordPresentFinal,aes(x=Longitude,y=Latitude,size=`Number of Victim Fatalities`,col=Party))
...
gg1 + geom_point(data=joinedAllFinal,aes(x=long,y=lat,size=X..Killed,color=Party)) + ggtitle("Mass Shootings Kaggle 2014-2016") 
```
