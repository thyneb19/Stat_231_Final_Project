...
gg1 + geom_point(data=joinedStanfordPresentFinal,aes(x=Longitude,y=Latitude,size=`Number of Victim Fatalities`,col=Party)) + ggtitle("Mass Shootings Reported by Media 2014-2016")
...
gg1 + geom_point(data=joinedAllFinal,aes(x=long,y=lat,size=X..Killed,color=Party)) + ggtitle("Mass Shootings Reported to Police 2014-2016")
```
...
missedByStanford <- anti_join(joinedAllFinal,joinedStanfordPresentFinal,by=c("City.Or.County"="City","State"))
```
