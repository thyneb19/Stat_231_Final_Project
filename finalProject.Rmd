...
gg1 + geom_point(data=joinedAllFinalv2,aes(x=long,y=lat,size=X..Killed,color=Party)) + ggtitle("Mass Shootings Kaggle 2014-2016") + scale_color_manual(values=c("#0004ff", "#ff0027"))
```
